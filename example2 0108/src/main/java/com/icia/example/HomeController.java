...
public class HomeController {
	...
	public ModelAndView getUserList(@RequestParam(value = "page", required = false,defaultValue = "1") int page){
		mav = us.getUserList(page);
		return mav;
	}
	@RequestMapping(value = "UserDelete")
	public ModelAndView UserDelete(@RequestParam String uid){
		mav = us.UserDelete(uid);
		return mav;
	}
