...
<table>
<tr> <td> 제목 </td> <td> <input type="text" name="btitle" required> </td> </tr>
<tr> <td> 작성자 </td> <td> <input type="text" name="bwriter" required> </td> </tr>
<tr> <td> 글비밀번호 </td> <td> <input required type="password" name="bpwd"> </td> </tr>
<tr> <td colspan="2" style="padding: 0"> <textarea rows="15" cols="40" style="resize: none;" name="bcontents"></textarea> </td> </tr>
<tr> <td>파일</td> <td><input type="file" name="bfile"></td> </tr>
