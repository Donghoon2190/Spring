			...
			<div class="contact-info">
				...
				<div class="contact-form">   
				  <div class="col-sm-offset-2 col-sm-10">
					<button class="btn btn-default aa" style="width: 100%; height: 50px" onclick="location.href='LoginPage'">Login</button>
				  </div>
				  </div>
				</div>
			</div>
		...
		<div class="col-md-9" >
			...
			<form action="userReg" method="post" name="formN" enctype="multipart/form-data">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
					<input required type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" maxlength="11" id="uphone" placeholder="Enter Phone Number" name="uphone">
				  </div>
				</div>
				<div class="form-group">        
				...
				<div class="form-group">        
				  <div class="col-sm-offset-2 col-sm-10">
					<button class="btn btn-default aa" onclick="gosubmit()">Submit</button>
				  </div>
				</div>
