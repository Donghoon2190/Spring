...
<tr> <th> 아이디 </th> <td> <strong> ${member.mid}</strong> </td> <td> <input type="hidden" name="mid" value="${member.mid}"> <strong> ${member.mid}</strong></td> </tr>
...
<tr><th> 핸드폰번호 </th><td>${member.mphone}</td> <td><input type="text" name="mphone">  </td> </tr>
 ...
 <tr> <td colspan="3"> <input type="button" value="메인으로" onclick="location.href='main'"> <input type="submit" value="수정"> </td> </tr>
</table>
</form>
</body>
</html>
